...
func RegisterLogCommands(parent *flags.Parser) {
	...
	if err != nil {
		Error.Fatalf("Unable to register log commands with bossctl command parser: %s", err.Error())
	}
}
...
// bossctl loglevel set level <componentName1#packageName> <componentName2>
